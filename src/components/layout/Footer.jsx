...
import { lastUpdated } from "@/data/constants";
    ...
    <footer className="relative border-t border-border/70 bg-background/40 backdrop-blur-sm">
      <FxSplit block={5}>
        ...
        <p className="text-muted-foreground">
          <span className="text-foreground">✱</span> © {new Date().getFullYear()} · built with{" "}
          <Heart className="inline h-3.5 w-3.5 text-foreground" fill="currentColor" />
          {" "}by{" "}
          <span className="text-foreground">Pranay Patle</span>
        </p>
